...
for iteration = 1 : maxIterations
    ...
    TMP1 = currFiltImg_A(1:end-(width-1),1:end-(width-1));
    TMP2 = currFiltImg_B(1:end-(width-1),1:end-(width-1));
    jointSample = [TMP1(1:13:end) TMP2(1:13:end)];
%     jointSample = [currFiltImg_A(hA+1:21:end-hA) currFiltImg_B(hB+1:13:end-hB)]; % old, wrong, version
